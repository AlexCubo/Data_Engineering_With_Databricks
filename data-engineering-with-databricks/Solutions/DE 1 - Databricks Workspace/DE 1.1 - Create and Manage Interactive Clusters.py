...
# MAGIC 1. Set the **Cluster mode** to **Single Node**
# MAGIC 1. Set the access mode to **Single User** and ensure your username is selected (this mode is required to run this course)
